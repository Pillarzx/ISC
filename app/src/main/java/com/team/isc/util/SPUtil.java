...
/**
 * Created by ZX on 2019/4/6.
 */

public class SPUtil {

    private static SharedPreferences sharedPreferences;
    private static SPUtil prefsInstance;

    private static final String preferencesName = "useraccount";
     ...
     */
    public static SPUtil init(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new SPUtil(context);
        }
